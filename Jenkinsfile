pipeline {
    agent any
    environment {
        DOCKER_HUB_REPO = "sesunda970/studybuddy"
    ...
    stages {
        stage('Checkout Github') {
            steps {
                ...
                checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/sesunda/STUDY-BUDDY-AI.git']])
            }
        }        
